...
for ($i = 0; $i < iterator_count($array); ++$i) {  // NOK {{Avoid getting the size of the collection in the loop}}
    var_dump($array[$i]);
}

$size = iterator_count($array);
for ($i = 0; $i < $size; ++$i) {  // Compliant
    var_dump($array[$i]);
}
...
for ($i = 0; iterator_count($array) > $i; ++$i) {  // NOK {{Avoid getting the size of the collection in the loop}}
    var_dump($array[$i]);
}
...
$i = 0;
while ($i < iterator_count($array)) { // NOK {{Avoid getting the size of the collection in the loop}}
    var_dump($array[$i]);
    ++$i;
}
